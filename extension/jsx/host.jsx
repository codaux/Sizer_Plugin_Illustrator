...
function buildReportSizeHtml(row){
    ...
    return [
        "<table class='size-mini mono'><tbody>",
        "<tr><td class='axis'>W</td><td class='size-value'>" + escHtml(orderW) + "</td><td class='size-value size-output'>" + escHtml(outputW) + "</td></tr>",
        "<tr><td class='axis'>H</td><td class='size-value'>" + escHtml(orderH) + "</td><td class='size-value size-output'>" + escHtml(outputH) + "</td></tr>",
        row.delta ? "<tr><td class='size-delta' colspan='3'>" + escHtml(row.delta) + "</td></tr>" : "",
        "</tbody></table>"
    ].join("");
}
